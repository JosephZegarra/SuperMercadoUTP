...
public class Proveedores 
{
    ...
    public Proveedores(String IdProveedor, String NombreCompania, String NombreContacto, String CargoContacto,
    ...
    {
        return IdProveedor + "; " + NombreCompania + "; " + NombreContacto + "; " + CargoContacto + "; " +
